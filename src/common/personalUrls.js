...
export const paypalLink = `https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&no_shipping=1&business=hscii.firefox@gmail.com&item_name=hnskrit for ${browserName} - Donation`;
